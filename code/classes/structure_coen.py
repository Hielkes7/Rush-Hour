import csv, os, random, statistics, xlsxwriter
import matplotlib.pyplot as plt

# need to install xlsxwriter using pip install --user XlsxWriter
class Game():
    """
        Creates a game.
    """
    ...
    # def average_moves(self, moves):
    #     moves = moves
    #     algorithm = "hiele"
    #     wincon = "win-hiele"
    #     print("hello world")
    #     print (algorithm, wincon, "moves required", moves)
    #
    #
